...
import oscarblancarte.ipd.state.states.ShudingDownState;
...
public class MessageProcess {
    ...
    public boolean queueMessage(String message) {
        if(server.getState() instanceof ShudingDownState){
            System.out.println("Sever is shuting down, no more messages would be sended");
            return false;
        }else{
